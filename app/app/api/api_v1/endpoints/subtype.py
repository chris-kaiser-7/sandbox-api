...
@router.post("/subtypes_generate/", response_model=models.Assistant)
async def create_subtype(
    *,
    ...
    existing_subtype = await crud.subtype.get_by_name_and_book(db=db, name=obj_in.parent, book=obj_in.book)
